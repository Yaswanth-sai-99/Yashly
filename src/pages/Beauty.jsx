  ...
  return (
    <>
      <div className='flex flex-1  items-center bg-green-50 mt-6'>
        ...
        <h1 className='text-green-600 font-bold font-futuristic text-3xl my-4 px-10'>Beauty Products</h1>
      </div>
      <div className='grid grid-cols-1 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-5 max-w-full px-5 py-10'>
        {products.filter((data1) => data1.category === "beauty").map((item, index) => (
